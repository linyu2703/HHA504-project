...
## Project Overview
This project contains the design documents for a Remote Patient Monitoring (RPM) Data Pipeline, a small, realistic healthcare cloud based solution. The architecture is designed to securely retrieve data from patient wearables, process it using serverless compute (services like Azure and GCP), and present aggregated metrics and alerts to clinical staff through (Tableau and PostgreSQL).
